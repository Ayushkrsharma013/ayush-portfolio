...
function HeroGeometric({
    ...
    // PERMANENT FIX: Properly typed variants with explicit return types
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <a
                            href="#projects"
                            className="px-6 py-3 bg-white text-black rounded-lg font-semibold hover:bg-white/90 transition text-sm sm:text-base"
                        >
                            View Projects
                        </a>
<a
